...
void Player::update(RenderWindow &window, float time_speed_up, float speed_up, vector<Object> *objects) {
    ...
    for (auto obj : *objects){
        ...
        {
            if (collision_wall(player_x_, player_y, Object))
            {
                moveX = 0;
            }
            if (collision_wall(player_x, player_y_,Object))
            {
                moveY = 0;
            }
        }
